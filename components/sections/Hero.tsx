    ...
    <div className="mt-20 flex min-h-[525px] px-10">
      <div className="w-2/5">
        ...
        <div className="flex mt-12 items-center space-x-6">
          <Button className="dark:text-black custom-button-transition">Start Building for Free</Button>
          <div className="group flex items-center text-primary cursor-pointer">
            Get a demo
            <MoveRight
