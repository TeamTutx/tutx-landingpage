...
export default function Story() {
  ...
  return (
    <div id="story" className="flex flex-col items-center space-y-10 py-16 px-4 sm:px-10">
      <div className="flex">
      ...
      <div className="flex items-center justify-center text-muted-foreground">
        <div className="w-full lg:w-2/3 space-y-6 text-center text-sm lg:text-base">
          <div>{story}</div>
        </div>
      </div>
    </div>
