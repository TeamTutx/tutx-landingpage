        ...
        return (
          ...
          >
            <div>
              ...
              {index <= value && (
                <CheckFilled className={cn('text-black dark:text-white', value === index && 'text-black opacity-100 dark:text-primary')} />
              )}
            </div>
            <span className={cn('text-black dark:text-white', value === index && 'text-black opacity-100 dark:text-primary')}>
              {loadingState.text}
            </span>
          </motion.div>
        );
