    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 top-1/2 flex items-start justify-start overflow-hidden rounded-2xl border border-zinc-200 bg-background p-4 transition duration-700 group-hover/pin:border-white/[0.2] dark:border-primary/15"
        >
