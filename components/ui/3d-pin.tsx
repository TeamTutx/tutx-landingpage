    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2  flex justify-start items-start  rounded-2xl  bg-background dark:border-primary/15 border border-zinc-200 group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden"
        >
