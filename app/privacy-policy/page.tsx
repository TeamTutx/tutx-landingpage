    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose prose-sm sm:prose lg:prose-lg dark:prose-invert">
        ...
        <section className="mb-8">
          ...
          <p>
            Tutx ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, 
            use, disclose, and safeguard your information when you use our coaching management platform. 
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            If you wish to cancel your account or request that we no longer use your information, please contact us. 
        ...
        <section className="mb-8">
          ...
          <p>
            Our platform may integrate with third-party services for specific functionalities such as payment processing 
            and communication (WhatsApp/email). These third parties may collect information about you when you use our platform. 
